    ...
    L.geoJSON(data, {
        ...
        onEachFeature: function (feature, layer) {
            ...
            const descriptionText = description 
                ? `<p><span style="font-size: 13px; italic;font-style: italic; font-weight: 200; color: #00FF82; display: inline-block; max-width: 225px; word-wrap: break-word; overflow-wrap: break-word;">“${description}”</span></p>` 
                : '';
